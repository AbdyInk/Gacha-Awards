  ...
  return (
    ...
    <div className="home-container">
      <Flex mt={3} className="SubContainer">
        <Heading as="h1" pt={4} size="2xl" mb={2} color="yellow.300" style={{ fontFamily: 'Eracake'}}>GACHA AWARDS 2024</Heading>
        ...
        <Heading as="h1" size="xl" mb={4} color="gray.200" style={{ fontFamily: 'Eracake'}}>PRESENTADOR</Heading>
        ...
        <Heading as="h1" size="xl" mb={4} color="gray.200" style={{ fontFamily: 'Eracake'}}>PATROCINADO</Heading>
        ...
        <Heading as="h1" size="xl" mb={4} color="gray.200" style={{ fontFamily: 'Eracake'}}>PARTICIPANTES</Heading>
